      ...
      <Container>
        ...
        >
          ...
          <Form.Group  className="mb-3" controlId="address1">
            ...
            <Form.Control  {...register("address_line_1")} type="text" placeholder="Street"></Form.Control>
          ...
          <Row>
            <Col>
              <Form.Group  className="mb-3" controlId="address2">
                ...
                <Form.Control  {...register("address_line_2")}
                  type="text"
            ...
            <Col>
              <Form.Group className="mb-3" controlId="address3">
                ...
                <Form.Control {...register("address_line_3")}
                  type="text"
                  placeholder="
          ...
          <Form.Group className="mb-3" controlId="medicalConditions">
            ...
            <Form.Control {...register("medical_conditions")}
              as="textarea"
