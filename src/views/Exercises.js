  ...
  return (
    <div className="cardcontainer">
        ...
        <div className="filterwrapper">
          <Container>
            <Row>
              <Col>
                <img
                  src="/assets/muscle/person.png"
                  alt="muscle img"
                  onClick={() => filterList(null)}
                ></img>
                <img
                  src="/assets/muscle/abs.png"
                  alt="muscle img"
                  onClick={() => filterList("Abs")}
                ></img>
                <img
                  src="/assets/muscle/biceps.png"
                  alt="muscle img"
                  onClick={() => filterList("Biceps")}
                ></img>
                <img
                  src="/assets/muscle/quads.png"
                  alt="muscle img"
                  onClick={() => filterList("Quads")}
                ></img>
                <img
                  src="/assets/muscle/chest.png"
                  alt="muscle img"
                  onClick={() => filterList("Chest")}
                ></img>
                <img
                  src="/assets/muscle/forearms.png"
                  alt="muscle img"
                  onClick={() => filterList("Forearms")}
                ></img>
              </Col>
            </Row>
          </Container>
      ...
      <Container className="p-3 mb-5">
        <div className="accordiongrid">{exerciseList}</div>
      </Container>
    </div>
  );
};
